...
/**
 * Performance test for the PayBack entity.
 */
class PayBackGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PayBack entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created payBack")
                .get("${new_payBack_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created payBack")
            .delete("${new_payBack_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
