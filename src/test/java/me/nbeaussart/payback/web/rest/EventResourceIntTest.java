...
public class EventResourceIntTest {
    ...
    public void initTest() {
        ...
        event.setSendinEmail(DEFAULT_SENDIN_EMAIL);
    }
    ...
    public void createEvent() throws Exception {
        ...
        assertThat(testEvent.isSendinEmail()).isEqualTo(DEFAULT_SENDIN_EMAIL);
    }
    ...
    public void updateEvent() throws Exception {
        ...
        updatedEvent.setSendinEmail(UPDATED_SENDIN_EMAIL);
        ...
        assertThat(testEvent.isSendinEmail()).isEqualTo(UPDATED_SENDIN_EMAIL);
    }
