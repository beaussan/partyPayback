package me.nbeaussart.payback.config;

import me.nbeaussart.payback.security.*;
import me.nbeaussart.payback.web.filter.CsrfCookieGeneratorFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.POST, "/api/events/full").permitAll()
